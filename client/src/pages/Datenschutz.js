  ...
  return (
    <>
      ...
      <p>
        ...
        Geschäftsleitung der Michail Mangasarov. Eine Nutzung der Internetseiten
        der Michail Mangasarov ist grundsätzlich ohne jede Angabe
      ...
      <p>
        ...
        Übereinstimmung mit den für die Michail Mangasarov geltenden
      ...
      <p>
        Die Michail Mangasarov hat als für die Verarbeitung Verantwortlicher
      ...
      <p>
        Die Datenschutzerklärung der Michail Mangasarov beruht auf den
      ...
      <p>Michail Mangasarov</p>
      <p>Cimbernstr., 13a</p>
      <p>81369 München</p>
      <p>Deutschland</p>
      <p>Tel.: +4917656763760</p>
      <p>E-Mail: kontakt@kindersport-wissen.de</p>
      <p>Website: www.spielplatzchecken.de</p>

      <h4>3. Erfassung von allgemeinen Daten und Informationen</h4>
      <p>
        Die Internetseite der Michail Mangasarov erfasst mit jedem Aufruf der
      ...
      <p>
        ...
        Michail Mangasarov keine Rückschlüsse auf die betroffene Person. Diese
        ...
        erhobenen Daten und Informationen werden durch die Michail Mangasarov
      ...
      <p>
        Die Internetseite der Michail Mangasarov enthält aufgrund von
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            Person die Löschung von personenbezogenen Daten, die bei der Michail
            Mangasarov gespeichert sind, veranlassen möchte, kann sie sich
            hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
            Verantwortlichen wenden. Der Mitarbeiter der Michail Mangasarov wird
            veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.
          </p>

          <p>
            Wurden die personenbezogenen Daten von der Michail Mangasarov
            öffentlich gemacht und ist unser Unternehmen als Verantwortlicher
            gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten
            verpflichtet, so trifft die Michail Mangasarov unter
            ...
            die Verarbeitung nicht erforderlich ist. Der Mitarbeiter der Michail
            Mangasarov wird im Einzelfall das Notwendige veranlassen.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            bei der Michail Mangasarov gespeichert sind, verlangen möchte, kann
            sie sich hierzu jederzeit an einen Mitarbeiter des für die
            Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Michail
            Mangasarov wird die Einschränkung der Verarbeitung veranlassen.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            betroffene Person jederzeit an einen Mitarbeiter der Michail
            Mangasarov wenden.
          </p>
        </li>
        <li>
          ...
          <p>
            Die Michail Mangasarov verarbeitet die personenbezogenen Daten im
          ...
          <p>
            Verarbeitet die Michail Mangasarov personenbezogene Daten, um
            ...
            steht. Widerspricht die betroffene Person gegenüber der Michail
            Mangasarov der Verarbeitung für Zwecke der Direktwerbung, so wird
            die Michail Mangasarov die personenbezogenen Daten nicht mehr für
          ...
          <p>
            ...
            Verarbeitung personenbezogener Daten, die bei der Michail Mangasarov
          ...
          <p>
            ...
            Person direkt an jeden Mitarbeiter der Michail Mangasarov oder einen
        ...
        <li>
          ...
          <p>
            ...
            der betroffenen Person, trifft die Michail Mangasarov angemessene
      ...
      <p>
        ...
        <a href="https://dg-datenschutz.de/datenschutz-dienstleistungen/datenschutz-audit/">
          Datenschutzaudit
        </a>{" "}
        durchführt, in Kooperation mit der{" "}
        <b>
          <a href="https://www.wbs-law.de/taetigkeitsgebiete/medienrecht/">
